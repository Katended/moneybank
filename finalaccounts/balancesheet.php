...
<?php require('../'.DIR_WS_INCLUDES . 'initmenu.php'); ?>
			<form action="trialbal.php?action=insert" method="post" style="width:100%;height:auto;" id='frmbalancesheet' name='frmbalancesheet' onReset="document.getElementById('action').value='add';">
