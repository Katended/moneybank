	...
	function DrawComboFromArray($allaccounts=array(),$fieldname='',$selected_id='',$type ='combo',$onChange="",$ctype="",$frmid=""){
       ...
       case 'FREQUENCY':
        ...
        case 'PRODGLTDACC':
            ...
            case 'PRODGLACCS':
                 $glitems = array('PRINCIPAL_OUTSTANDING_ACC'=>'Principal Outstanding',
            ...
            case 'PRODGLSAV':
                ...
                break;
            case 'PRODGLTDACC':
                $glitems = array('TIMEDEPOSIT_ACC'=>'Time Deposit Account',
...
function FindFinYear($dStart,$dEnd,$StartYear,$EndYear){
	...
	$i = date("Y", strtotime(STARTFINYEAR)); + 1;
