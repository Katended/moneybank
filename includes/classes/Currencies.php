...
class Currencies {
    ...
    static $currencies = array();
      ...
      public static function getInstance() {
        ...
        while ($currencies = tep_db_fetch_array($currencies_query)) {
            self::$currencies[$currencies['code']] = array('title' => $currencies['title'],
    ...
    public static function updateCurrency(&$formdata) {
        ...
        try {
            ...
            foreach ($formdata as $key => $value):
                $value['TABLE'] = TABLE_CURRENCYDENO;
                Bussiness::prepareBulkStatement(array($value), true);
            endforeach;
