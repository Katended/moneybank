<?php
	...
	,'SETTING_DAYS_MONTH'=>tep_db_prepare_input($_POST['SETTING_DAYS_MONTH'])
	,'SETTING_DAYS_WEEK'=>tep_db_prepare_input($_POST['SETTING_DAYS_WEEK']));	
	//print_r($setting->configurationsettings);
