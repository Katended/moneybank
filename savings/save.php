...
<form id="frmSave" name='frmSave'>
   ...
   <div class="client_options ">
        ...
        <tr>
            <td><?php echo $lablearray['1197'];?><br><input type="text" id="txtsavaccount" name="txtsavaccount" value="" readonly="readonly" ></td>
                ...
                <td>
                   ...
                   <input type="text" id="txtvoucher" name="txtvoucher" value=""><?php echo TEXT_FIELD_REQUIRED;?></td>
               </td>
          </tr>
        <tr>
    ...
    <div class="button-container">
        ...
        <span><button class="btn" name="btnSave"  type="button"   id="btnSave"><?php echo $lablearray['20'];?></button></span></div>
   </div>      
